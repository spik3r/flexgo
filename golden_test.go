...
var exampleGoldens = []string{
	...
	"basics/centered",
	"basics/debug_tree",
	"basics/gap_vs_spacebetween",
	"basics/justify",
	"basics/min_max",
	"basics/spacing",
	"builder/alignself",
	"builder/basic",
	"builder/layouts/dashboard",
	"builder/layouts/form",
	"builder/layouts/grid",
	"builder/layouts/headerbodyfooter",
	"builder/layouts/modal",
	"builder/layouts/splitpane",
	"builder/layouts/tabs",
	"dynamic",
	"layouts/dashboard",
	"layouts/form",
	"layouts/grid",
